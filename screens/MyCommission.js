...
const MyCommission = ({ route, navigation }) => {
  ...
  const filteredCommissions =
    commissions?.commission_data?.filter((commission) => {
                    ...
                    <View style={styles.summaryBoxesContainer}>
                      ...
                      >
                        ...
                        <Text style={styles.summaryValue}>
                          {commissions?.summary?.total_customers}
                        </Text>
                      </Animated.View>
                      <Animated.View
                        style={[
                      ...
                      >
                        ...
                        <Text style={styles.summaryValue}>
                          {commissions?.summary?.total_groups}
                        </Text>
                      </Animated.View>
                      <Animated.View
                        style={[
                      ...
                      >
                        ...
                        <Text style={styles.summaryValue}>
                          {commissions?.summary?.actual_business}
                        </Text>
                      </Animated.View>
                      <Animated.View
                        style={[
                      ...
                      >
                        ...
                        <Text style={styles.summaryValue}>
                          {commissions?.summary?.total_actual}
                        </Text>
                      </Animated.View>
                    </View>
                  )}
